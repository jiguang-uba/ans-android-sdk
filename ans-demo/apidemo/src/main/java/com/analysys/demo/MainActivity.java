 ...
 * @author: huchangqing
 */
public class MainActivity extends BaseActivity implements ViewPager.OnPageChangeListener, ANSAutoPageTracker {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AnalysysAgent.getDistinctId(this);
